...
<script type="text/javascript">
    $(document).ready(function(){
        $(document).on('click',"#second-images-thumbnails .btn-default",function(e){

            $("#second-images-thumbnails").empty();
            $('#second-success').html('').parent().hide();
            $('#second-errors').html('').parent().hide();
            $.get(window.location.href+"&deleteSecond=1");
            e.stopPropagation();
            return false;
        });
    });

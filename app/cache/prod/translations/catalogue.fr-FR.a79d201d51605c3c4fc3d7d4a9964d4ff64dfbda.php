...
$catalogue = new MessageCatalogue('fr-FR', array (
  ...
  array (
    ...
    '- One after another: Apply taxes one after another (e.g.: 0 + 10% = 0 + 5% = 5.5)' => '- L\'une après l\'autre : applique les taxes les unes après les autres (ex. : 100 + 10% = 110 + 5% = 115.5)',
    'No Tax' => 'Aucune taxe',

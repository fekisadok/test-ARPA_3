...
class AdminCategoriesControllerCore extends AdminController
{
    ...
    public function renderForm()
    {
		...
		$image1 = _PS_CAT_IMG_DIR_.$obj->id.'1.'.$this->imageType;
        $image_url1 = ImageManager::thumbnail($image1, $this->table.'_'.(int)$obj->id.'1.'.$this->imageType, 350, $this->imageType, true, true);
